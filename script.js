...
let app = {
    ...
    nextQuestion: function(user) {
        ...
        if(this.currentPos == questions.length && totalPoints <= 4) {
                window.location.href = "./Final >= 4 pontos/final1.html"
        } else if(this.currentPos == questions.length && totalPoints == 5) {
            window.location.href = "./Final%20+5%20pontos/final2.html"
            };
    ...
    heartScoreChange: function() {
        if(totalPoints === 0) {
            ...
            //window.location.href = "./Final +5 pontos/final2.html"
         } 
     },
